...
"""
Sprint 4 快速功能测试脚本
验证协程池、背压控制和Protocol Buffers的基本功能
"""
...
async def test_backpressure():
    ...
    # 测试熔断器
    print("✅ 测试熔断器")
    from src.core.backpressure_controller import CircuitBreaker, CircuitBreakerConfig
    ...
    assert breaker.state.value == "open", "熔断器应该打开"
...
async def benchmark():
    ...
    from src.utils.performance_utils import benchmark_throughput
...
async def main():
    ...
    try:
        ...
        # 清理
        print("\n🔄 清理资源...")
        from src.utils.performance_utils import cleanup_performance_system
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("⚠️  警告: prometheus_client 未安装")
